#
# Project file for the SpidrTpx3Lib library (CERN probestation flavour)
#
# To generate a Visual Studio project:
#   qmake -t vclib SpidrTpx3Lib-ProbeStation.pro
# To generate a Makefile:
#   qmake SpidrTpx3Lib-ProbeStation.pro
#
...
DEFINES += MY_LIB_EXPORT CERN_PROBESTATION
