...
void main(void) {
    ...
    v[1] = texture(tex,vec3(c+vec2(1./128.,0),frameID)).r;
    v[2] = texture(tex,vec3(c+vec2(-1./128.,0),frameID)).r;
    v[3] = texture(tex,vec3(c+vec2(0,1./128.),frameID)).r;
    v[4] = texture(tex,vec3(c+vec2(0,-1./128.),frameID)).r;
