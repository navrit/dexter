...
int QCstmEqualization::PrepareInterpolation(int setId, int DAC_Disc_code) {
...
int QCstmEqualization::DAC_Disc_Optimization(int setId, int DAC_Disc_code) {
...
void QCstmEqualization::SetAllAdjustmentBits(int val_L, int val_H) {
