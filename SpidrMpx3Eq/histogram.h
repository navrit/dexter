...
//CONTAINER WRAPPERS
  decltype(m_bins.begin()) begin(){return m_bins.begin();}
  decltype(m_bins.rbegin()) rbegin(){return m_bins.rbegin();}
  decltype(m_bins.crbegin()) crbegin(){return m_bins.crbegin();}
  decltype(m_bins.cbegin()) cbegin(){return m_bins.cbegin();}

  decltype(m_bins.end()) end(){return m_bins.end();}
  decltype(m_bins.rend()) rend(){return m_bins.rend();}
  decltype(m_bins.crend()) crend(){return m_bins.crend();}
  decltype(m_bins.cend()) cend(){return m_bins.cend();}
