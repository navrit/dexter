...
//  void ClearParsMap();
  ...
  void setTargetPos(int motorid, long long int targetPos) {
    _parsMap[motorid].targetPos = targetPos;
  }
  long long int getTargetPos(int motorid) {
    return _parsMap[motorid].targetPos;
  }
  ...
  // Calibration
  bool SetStepAngleCalibration(int motorid,
