...
/*
int CCONV QCstmCT::AttachHandler(CPhidgetHandle stepper, void *userptr)
{
	int serialNo;
	const char *name;
...
int CCONV QCstmCT::DetachHandler(CPhidgetHandle stepper, void *userptr)
{
	int serialNo;
	const char *name;
...
int CCONV QCstmCT::ErrorHandler(CPhidgetHandle stepper, void *userptr, int ErrorCode, const char *Description)
{
	printf("Error handled. %d - %s\n", ErrorCode, Description);
	return 0;
}

int CCONV QCstmCT::PositionChangeHandler(CPhidgetStepperHandle stepper, void *usrptr, int Index, __int64 Value)
{
...
int QCstmCT::display_properties(CPhidgetStepperHandle phid)
{
