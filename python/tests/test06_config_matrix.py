...
class test06_config_matrix(tpx3_test):
  ...
  def _execute(self,**keywords):
    ...
    vomiting_pixels=set()
#    self.tpx.setReadoutSpeed(640)
#    self.logging.info("Links speed %d Mbps"%self.tpx.getReadoutSpeed())
    ...
    #      self.tpx.setLogLevel(0)
          ...
          self.tpx.sequentialReadout(tokens=1,now=True)
          if 0 and len(data)>256*(256+1):
            print len(data)
