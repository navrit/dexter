...
int main( int argc, char *argv[]) 
{
    ...
    id[3] = ( hdr.headerId >> 24 ) & 0xFF;
    id[2] = ( hdr.headerId >> 16 ) & 0xFF;
    id[1] = ( hdr.headerId >>  8 ) & 0xFF;
    id[0] = ( hdr.headerId >>  0 ) & 0xFF;
    id[4] = '\0';

    devid[3] = ( hdr.devHeader.headerId >> 24 ) & 0xFF;
    devid[2] = ( hdr.devHeader.headerId >> 16 ) & 0xFF;
    devid[1] = ( hdr.devHeader.headerId >>  8 ) & 0xFF;
    devid[0] = ( hdr.devHeader.headerId >>  0 ) & 0xFF;
    devid[4] = '\0';
    ...
    cout << "=============================================================== " << endl;
    cout << "   ID                           0x" << hex << hdr.headerId << dec << " (" << id << ")" << endl;
    ...
    cout << "   Data filter                  0x" << hex << std::setw(4) << hdr.spidrFilter <<  dec << endl;
    cout << "--------------------------------------------------------------- " << endl;
    ...
    cout << "=============================================================== " << endl;
    cout << "   ID                           0x" << hex << hdr.devHeader.headerId << dec << " (" << devid << ")" << endl;
    cout << "   Total size                     " << hdr.devHeader.headerSizeTotal << endl;
    cout << "   Size                           " << hdr.devHeader.headerSize << endl;
    cout << "   Format                       0x" << hex << std::setw(8) << std::setfill('0') << hdr.devHeader.format << endl;
    cout << "--------------------------------------------------------------- " << endl;
    cout << "   Device ID                    0x" << hdr.devHeader.deviceId << endl;
    cout << "--------------------------------------------------------------- " << endl;
